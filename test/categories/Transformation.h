...
TEST(Transformations, Rotate)
{
    ...
    hmm_mat4 rotateX = HMM_Rotate(HMM_ToRadians(90.0f), HMM_Vec3(1, 0, 0));
    ...
    hmm_mat4 rotateY = HMM_Rotate(HMM_ToRadians(90.0f), HMM_Vec3(0, 1, 0));
    ...
    hmm_mat4 rotateZ = HMM_Rotate(HMM_ToRadians(90.0f), HMM_Vec3(0, 0, 1));
