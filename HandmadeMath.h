...
COVERAGE(HMM_SinF, 1)
HMM_DEF float HMM_PREFIX(SinF)(float Radians)
{
...
COVERAGE(HMM_CosF, 1)
HMM_DEF float HMM_PREFIX(CosF)(float Radians)
{
...
COVERAGE(HMM_TanF, 1)
HMM_DEF float HMM_PREFIX(TanF)(float Radians)
{
...
HMM_DEF float HMM_PREFIX(ACosF)(float Radians)
{
...
HMM_DEF float HMM_PREFIX(ATanF)(float Radians)
{
...
HMM_DEF float HMM_PREFIX(ATan2F)(float Left, float Right)
{
...
COVERAGE(HMM_ExpF, 1)
HMM_DEF float HMM_PREFIX(ExpF)(float Float)
{
...
COVERAGE(HMM_LogF, 1)
HMM_DEF float HMM_PREFIX(LogF)(float Float)
{
...
HMM_DEF float HMM_PREFIX(SquareRootF)(float Float)
{
...
HMM_DEF float HMM_PREFIX(RSquareRootF)(float Float)
{
...
HMM_DEF float HMM_PREFIX(PowerF)(float Base, float Exponent)
{
...
HMM_DEF float HMM_PREFIX(ToRadians)(float Degrees)
{
...
COVERAGE(HMM_Lerp, 1)
HMM_DEF float HMM_PREFIX(Lerp)(float A, float Time, float B)
{
...
HMM_DEF float HMM_PREFIX(Clamp)(float Min, float Value, float Max)
{
...
COVERAGE(HMM_Vec2, 1)
HMM_DEF hmm_vec2 HMM_PREFIX(Vec2)(float X, float Y)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(Vec2i)(int X, int Y)
{
...
COVERAGE(HMM_Vec3, 1)
HMM_DEF hmm_vec3 HMM_PREFIX(Vec3)(float X, float Y, float Z)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Vec3i)(int X, int Y, int Z)
{
...
COVERAGE(HMM_Vec4, 1)
HMM_DEF hmm_vec4 HMM_PREFIX(Vec4)(float X, float Y, float Z, float W)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Vec4i)(int X, int Y, int Z, int W)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Vec4v)(hmm_vec3 Vector, float W)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(AddVec2)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(AddVec3)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(AddVec4)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(SubtractVec2)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(SubtractVec3)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(SubtractVec4)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(MultiplyVec2)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(MultiplyVec2f)(hmm_vec2 Left, float Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(MultiplyVec3)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(MultiplyVec3f)(hmm_vec3 Left, float Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(MultiplyVec4)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(MultiplyVec4f)(hmm_vec4 Left, float Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(DivideVec2)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(DivideVec2f)(hmm_vec2 Left, float Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(DivideVec3)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(DivideVec3f)(hmm_vec3 Left, float Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(DivideVec4)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(DivideVec4f)(hmm_vec4 Left, float Right)
{
...
HMM_DEF hmm_bool HMM_PREFIX(EqualsVec2)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_bool HMM_PREFIX(EqualsVec3)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_bool HMM_PREFIX(EqualsVec4)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF float HMM_PREFIX(DotVec2)(hmm_vec2 VecOne, hmm_vec2 VecTwo)
{
...
HMM_DEF float HMM_PREFIX(DotVec3)(hmm_vec3 VecOne, hmm_vec3 VecTwo)
{
...
HMM_DEF float HMM_PREFIX(DotVec4)(hmm_vec4 VecOne, hmm_vec4 VecTwo)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Cross)(hmm_vec3 VecOne, hmm_vec3 VecTwo)
{
...
HMM_DEF float HMM_PREFIX(LengthSquaredVec2)(hmm_vec2 A)
{
...
HMM_DEF float HMM_PREFIX(LengthSquaredVec3)(hmm_vec3 A)
{
...
HMM_DEF float HMM_PREFIX(LengthSquaredVec4)(hmm_vec4 A)
{
...
HMM_DEF float HMM_PREFIX(LengthVec2)(hmm_vec2 A)
{
...
HMM_DEF float HMM_PREFIX(LengthVec3)(hmm_vec3 A)
{
...
HMM_DEF float HMM_PREFIX(LengthVec4)(hmm_vec4 A)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(NormalizeVec2)(hmm_vec2 A)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(NormalizeVec3)(hmm_vec3 A)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(NormalizeVec4)(hmm_vec4 A)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(FastNormalizeVec2)(hmm_vec2 A)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(FastNormalizeVec3)(hmm_vec3 A)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(FastNormalizeVec4)(hmm_vec4 A)
{
...
HMM_DEF __m128 HMM_PREFIX(LinearCombineSSE)(__m128 Left, hmm_mat4 Right)
{
...
COVERAGE(HMM_Mat4, 1)
HMM_DEF hmm_mat4 HMM_PREFIX(Mat4)(void)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Mat4d)(float Diagonal)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Orthographic)(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Perspective)(float FOV, float AspectRatio, float Near, float Far)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Translate)(hmm_vec3 Translation)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Scale)(hmm_vec3 Scale)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(Quaternion)(float X, float Y, float Z, float W)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(QuaternionV4)(hmm_vec4 Vector)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(AddQuaternion)(hmm_quaternion Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(SubtractQuaternion)(hmm_quaternion Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(MultiplyQuaternion)(hmm_quaternion Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(MultiplyQuaternionF)(hmm_quaternion Left, float Multiplicative)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(DivideQuaternionF)(hmm_quaternion Left, float Dividend)
{
...
HMM_DEF float HMM_PREFIX(DotQuaternion)(hmm_quaternion Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(NormalizeQuaternion)(hmm_quaternion Left)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(NLerp)(hmm_quaternion Left, float Time, hmm_quaternion Right)
{
...
HMM_DEF float HMM_PREFIX(Length)(hmm_vec2 A)
{
...
HMM_DEF float HMM_PREFIX(Length)(hmm_vec3 A)
{
...
HMM_DEF float HMM_PREFIX(Length)(hmm_vec4 A)
{
...
HMM_DEF float HMM_PREFIX(LengthSquared)(hmm_vec2 A)
{
...
HMM_DEF float HMM_PREFIX(LengthSquared)(hmm_vec3 A)
{
...
HMM_DEF float HMM_PREFIX(LengthSquared)(hmm_vec4 A)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(Normalize)(hmm_vec2 A)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Normalize)(hmm_vec3 A)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Normalize)(hmm_vec4 A)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(FastNormalize)(hmm_vec2 A)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(FastNormalize)(hmm_vec3 A)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(FastNormalize)(hmm_vec4 A)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(Normalize)(hmm_quaternion A)
{
...
HMM_DEF float HMM_PREFIX(Dot)(hmm_vec2 VecOne, hmm_vec2 VecTwo)
{
...
HMM_DEF float HMM_PREFIX(Dot)(hmm_vec3 VecOne, hmm_vec3 VecTwo)
{
...
HMM_DEF float HMM_PREFIX(Dot)(hmm_vec4 VecOne, hmm_vec4 VecTwo)
{
...
HMM_DEF float HMM_PREFIX(Dot)(hmm_quaternion QuatOne, hmm_quaternion QuatTwo)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(Add)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Add)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Add)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Add)(hmm_mat4 Left, hmm_mat4 Right)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(Add)(hmm_quaternion Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(Subtract)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Subtract)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Subtract)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Subtract)(hmm_mat4 Left, hmm_mat4 Right)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(Subtract)(hmm_quaternion Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(Multiply)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(Multiply)(hmm_vec2 Left, float Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Multiply)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Multiply)(hmm_vec3 Left, float Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Multiply)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Multiply)(hmm_vec4 Left, float Right)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Multiply)(hmm_mat4 Left, hmm_mat4 Right)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Multiply)(hmm_mat4 Left, float Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Multiply)(hmm_mat4 Matrix, hmm_vec4 Vector)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(Multiply)(hmm_quaternion Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(Multiply)(hmm_quaternion Left, float Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(Divide)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec2 HMM_PREFIX(Divide)(hmm_vec2 Left, float Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Divide)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec3 HMM_PREFIX(Divide)(hmm_vec3 Left, float Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Divide)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_vec4 HMM_PREFIX(Divide)(hmm_vec4 Left, float Right)
{
...
HMM_DEF hmm_mat4 HMM_PREFIX(Divide)(hmm_mat4 Left, float Right)
{
...
HMM_DEF hmm_quaternion HMM_PREFIX(Divide)(hmm_quaternion Left, float Right)
{
...
HMM_DEF hmm_bool HMM_PREFIX(Equals)(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_bool HMM_PREFIX(Equals)(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_bool HMM_PREFIX(Equals)(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_vec2 operator+(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec3 operator+(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec4 operator+(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_mat4 operator+(hmm_mat4 Left, hmm_mat4 Right)
{
...
HMM_DEF hmm_quaternion operator+(hmm_quaternion Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_vec2 operator*(hmm_vec2 Left, float Right)
{
...
HMM_DEF hmm_vec3 operator*(hmm_vec3 Left, float Right)
{
...
HMM_DEF hmm_vec4 operator*(hmm_vec4 Left, float Right)
{
...
HMM_DEF hmm_mat4 operator*(hmm_mat4 Left, float Right)
{
...
HMM_DEF hmm_quaternion operator*(hmm_quaternion Left, float Right)
{
...
HMM_DEF hmm_vec2 operator*(float Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_vec3 operator*(float Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_vec4 operator*(float Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_mat4 operator*(float Left, hmm_mat4 Right)
{
...
HMM_DEF hmm_quaternion operator*(float Left, hmm_quaternion Right)
{
...
HMM_DEF hmm_vec4 operator*(hmm_mat4 Matrix, hmm_vec4 Vector)
{
...
HMM_DEF hmm_bool operator==(hmm_vec2 Left, hmm_vec2 Right)
{
...
HMM_DEF hmm_bool operator==(hmm_vec3 Left, hmm_vec3 Right)
{
...
HMM_DEF hmm_bool operator==(hmm_vec4 Left, hmm_vec4 Right)
{
...
HMM_DEF hmm_vec2 operator-(hmm_vec2 In)
{
...
HMM_DEF hmm_vec3 operator-(hmm_vec3 In)
{
...
HMM_DEF hmm_vec4 operator-(hmm_vec4 In)
{
